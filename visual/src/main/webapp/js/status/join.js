...
$(document).ready(function() {
	...
	var option = {
			...
			colNames: [
				...
				'2kM2 미만','2k~4k','4k~6k','6k~8k','8k~10k','10k~15k','15k이상','내국인','외국인'
			],
			colModel: [
				...
				,{ name: 'kor', index:'kor', width:100,  align: 'right',formatter:'integer' }
				,{ name: 'frn', index:'frn', width:100,  align: 'right',formatter:'integer' }
				],
				height: 600,
				rowNum: 30,
				shrinkToFit : false,
