...
public class CityesStatusVo2 {
	...
	public long getCnbnprm() {
		return cnbnprm;
	}


	public void setCnbnprm(long cnbnprm) {
		this.cnbnprm = cnbnprm;
	}
	...
	public long getPrfpp() {
		return prfpp;
	}


	public void setPrfpp(long prfpp) {
		this.prfpp = prfpp;
	}
